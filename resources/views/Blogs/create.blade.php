                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group row mt-2">
                                    <label  class="col-form-label">upload image</label> <br>
...
@section('after_scripts')
    ...
    <script src="https://cdn.tiny.cloud/1/ui41xm5og1ddcipj3m3rprllqaik7e0g21k333juij2uw3h0/tinymce/5/tinymce.min.js"
